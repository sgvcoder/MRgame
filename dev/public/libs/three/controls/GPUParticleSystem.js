...
THREE.GPUParticleSystem = function(options) {
  ...
  self.particleNoiseTex = textureLoader.load("images/textures/particles/perlin-512.png");
  self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

  self.particleSpriteTex = textureLoader.load("images/textures/particles/particle2.png");
